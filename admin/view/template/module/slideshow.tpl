        ...
        <tbody id="module-row<?php echo $module_row; ?>">
          <tr>
            ...
            <td class="left"><select name="slideshow_module[<?php echo $module_row; ?>][position]">
				<?php if ($module['position'] == 'content_maintop') { ?>
                <option value="content_maintop" selected="selected"><?php echo $text_content_maintop; ?></option>
                <?php } else { ?>
                <option value="content_maintop"><?php echo $text_content_maintop; ?></option>
                <?php } ?>			
