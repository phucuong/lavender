      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        ...
        <div id="tab-image">
          <table class="form">
			...
			<tr>
              <td><span class="required">*</span> <?php echo $entry_image_cat; ?></td>
              <td><input type="text" name="config_image_cat_width" value="<?php echo $config_image_cat_width; ?>" size="3" />
                x
                <input type="text" name="config_image_cat_height" value="<?php echo $config_image_cat_height; ?>" size="3" />
                <?php if ($error_image_cat) { ?>
                <span class="error"><?php echo $error_image_cat; ?></span>
                <?php } ?></td>
            </tr>
			<tr>
        ...
        <div id="tab-payment">
        <h2><?php echo $text_nganluong; ?></h2>
          <table class="form">
          <tr>
          <td><span class="required">*</span> <?php echo $entry_merchant_site_code_nganluong; ?></td>
          <td><input type="text" name="nganluong_merchant_site_code" value="<?php echo $nganluong_merchant_site_code; ?>" />
           
        </tr>
        <tr>
          <td><span class="required">*</span> <?php echo $entry_secure_pass_nganluong; ?></td>
          <td><input type="text" name="nganluong_secure_pass" value="<?php echo $nganluong_secure_pass; ?>" />
           
        </tr>
        <tr>
          <td><span class="required">*</span> <?php echo $entry_receiver_nganluong; ?></td>
          <td><input type="text" name="nganluong_receiver" value="<?php echo $nganluong_receiver; ?>" />
            
        </tr>
        <tr>
          <td><?php echo $entry_currency_nganluong; ?></td>
          <td><select name="nganluong_currency_id">
              <?php foreach ($currencies as $currency) { ?>
              <?php if ($currency['currency_id'] == $nganluong_currency_id) { ?>
        ...
        <tr>
          <td><?php echo $entry_status_nganluong; ?></td>
          ...
          <h2><?php echo $text_baokim; ?></h2>
          <table class="form">
          <tr>
          <td><span class="required">*</span> <?php echo $entry_merchant_site_code_baokim; ?></td>
          <td><input type="text" name="baokim_merchant_site_code" value="<?php echo $baokim_merchant_site_code; ?>" />
           
        </tr>
        <tr>
          <td><span class="required">*</span> <?php echo $entry_secure_pass_baokim; ?></td>
          <td><input type="text" name="baokim_secure_pass" value="<?php echo $baokim_secure_pass; ?>" />
           
        </tr>
        <tr>
          <td><span class="required">*</span> <?php echo $entry_receiver_baokim; ?></td>
          <td><input type="text" name="baokim_receiver" value="<?php echo $baokim_receiver; ?>" />
            
        </tr>
        <tr>
          <td><?php echo $entry_currency_baokim; ?></td>
          <td><select name="baokim_currency_id">
              <?php foreach ($currencies as $currency) { ?>
              <?php if ($currency['currency_id'] == $baokim_currency_id) { ?>
              <option value="<?php echo $currency['currency_id']; ?>" selected="selected"><?php echo $currency['title']; ?></option>
              <?php } else { ?>
              <option value="<?php echo $currency['currency_id']; ?>"><?php echo $currency['title']; ?></option>
              <?php } ?>
        ...
        <tr>
          <td><?php echo $entry_status_baokim; ?></td>
          <td><select name="baokim_status">
