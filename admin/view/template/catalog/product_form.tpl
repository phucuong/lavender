          ...
          <div id="language<?php echo $language['language_id']; ?>">
            <table class="form">
              <tr>
                ...
                <td><input type="text" onblur="locdau();" id="product_description[<?php echo $language['language_id']; ?>][name]" name="product_description[<?php echo $language['language_id']; ?>][name]" size="100" value="<?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['name'] : ''; ?>" />
...
<script type='text/javascript'>
	...
	var str = (document.getElementById("product_description[<?php echo $this->config->get('config_language_id'); ?>][name]").value);// lấy chuỗi dữ liệu nhập vào từ form có tên title
