...
class Controllercontentcomment extends Controller {
	...
	public function insert() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->redirect($this->url->link('content/comment', 'token=' . $this->session->data['token'] . $url, 'SSL'));
		}
	...
	private function getList() {
		...
		$this->data['insert'] = $this->url->link('content/comment/insert', 'token=' . $this->session->data['token'] . $url, 'SSL');
		$this->data['delete'] = $this->url->link('content/comment/delete', 'token=' . $this->session->data['token'] . $url, 'SSL');	
		...
		$this->data['sort_news'] = $this->url->link('content/comment', 'token=' . $this->session->data['token'] . '&sort=pd.name' . $url, 'SSL');
		$this->data['sort_author'] = $this->url->link('content/comment', 'token=' . $this->session->data['token'] . '&sort=r.author' . $url, 'SSL');
		$this->data['sort_rating'] = $this->url->link('content/comment', 'token=' . $this->session->data['token'] . '&sort=r.rating' . $url, 'SSL');
		$this->data['sort_status'] = $this->url->link('content/comment', 'token=' . $this->session->data['token'] . '&sort=r.status' . $url, 'SSL');
		$this->data['sort_date_added'] = $this->url->link('content/comment', 'token=' . $this->session->data['token'] . '&sort=r.date_added' . $url, 'SSL');
		...
		$this->template = 'content/comment_list.tpl';
		$this->children = array(
			'common/header',
			'common/footer'
		);
	...
	private function getForm() {
		...
		if (!isset($this->request->get['comment_id'])) { 
			$this->data['action'] = $this->url->link('content/comment/insert', 'token=' . $this->session->data['token'] . $url, 'SSL');
		} else {
			$this->data['action'] = $this->url->link('content/comment/update', 'token=' . $this->session->data['token'] . '&comment_id=' . $this->request->get['comment_id'] . $url, 'SSL');
		}
		
		$this->data['cancel'] = $this->url->link('content/comment', 'token=' . $this->session->data['token'] . $url, 'SSL');
		...
		$this->template = 'content/comment_form.tpl';
		$this->children = array(
			'common/header',
			'common/footer'
		);
