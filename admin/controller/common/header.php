...
class ControllerCommonHeader extends Controller {
	protected function index() {
		...
		if (!$this->user->isLogged() || !isset($this->request->get['token']) || !isset($this->session->data['token']) || ($this->request->get['token'] != $this->session->data['token'])) {
			...
			$this->data['cat'] = $this->url->link('content/cat', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['news'] = $this->url->link('content/news', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['comment'] = $this->url->link('content/comment', 'token=' . $this->session->data['token'], 'SSL');
