...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		$this->data['entry_image_cat'] = $this->language->get('entry_image_cat');	
		...
		$this->data['tab_payment'] = $this->language->get('tab_buttonpayment');
		$this->data['text_nganluong'] = $this->language->get('text_nganluong');
		$this->data['entry_merchant_site_code_nganluong'] = $this->language->get('entry_merchant_site_code_nganluong');
		$this->data['entry_secure_pass_nganluong'] = $this->language->get('entry_secure_pass_nganluong');
		$this->data['entry_receiver_nganluong'] = $this->language->get('entry_receiver_nganluong');		
		$this->data['entry_currency_nganluong'] = $this->language->get('entry_currency_nganluong');		
		$this->data['entry_status_nganluong'] = $this->language->get('entry_status_nganluong');
		
		if (isset($this->request->post['nganluong_merchant_site_code'])) {
			$this->data['nganluong_merchant_site_code'] = $this->request->post['nganluong_merchant_site_code'];
		} else {
			$this->data['nganluong_merchant_site_code'] = $this->config->get('nganluong_merchant_site_code');
		}
		
		if (isset($this->request->post['nganluong_secure_pass'])) {
			$this->data['nganluong_secure_pass'] = $this->request->post['nganluong_secure_pass'];
		} else {
			$this->data['nganluong_secure_pass'] = $this->config->get('nganluong_secure_pass');
		}
		...
		if (isset($this->request->post['nganluong_currency_id'])) {
			$this->data['nganluong_currency_id'] = $this->request->post['nganluong_currency_id'];
		} else {
			$this->data['nganluong_currency_id'] = $this->config->get('nganluong_currency_id');
		}
		...
		if (isset($this->request->post['nganluong_status'])) {
			...
			$this->data['text_baokim'] = $this->language->get('text_baokim');
		$this->data['entry_merchant_site_code_baokim'] = $this->language->get('entry_merchant_site_code_baokim');
		$this->data['entry_secure_pass_baokim'] = $this->language->get('entry_secure_pass_baokim');
		$this->data['entry_receiver_baokim'] = $this->language->get('entry_receiver_baokim');		
		$this->data['entry_currency_baokim'] = $this->language->get('entry_currency_baokim');		
		$this->data['entry_status_baokim'] = $this->language->get('entry_status_baokim');
		
		if (isset($this->request->post['baokim_merchant_site_code'])) {
			$this->data['baokim_merchant_site_code'] = $this->request->post['baokim_merchant_site_code'];
		} else {
			$this->data['baokim_merchant_site_code'] = $this->config->get('baokim_merchant_site_code');
		}
		
		if (isset($this->request->post['baokim_secure_pass'])) {
			$this->data['baokim_secure_pass'] = $this->request->post['baokim_secure_pass'];
		} else {
			$this->data['baokim_secure_pass'] = $this->config->get('baokim_secure_pass');
		}
		
		if (isset($this->request->post['baokim_receiver'])) {
			$this->data['baokim_receiver'] = $this->request->post['baokim_receiver'];
		} else {
			$this->data['baokim_receiver'] = $this->config->get('baokim_receiver');
		}		
		
		if (isset($this->request->post['baokim_currency_id'])) {
			$this->data['baokim_currency_id'] = $this->request->post['baokim_currency_id'];
		} else {
			$this->data['baokim_currency_id'] = $this->config->get('baokim_currency_id');
		}
		...
		if (isset($this->error['image_cat'])) {
			$this->data['error_image_cat'] = $this->error['image_cat'];
		} else {
			$this->data['error_image_cat'] = '';
		} 
		...
		if (isset($this->request->post['config_image_cat_width'])) {
			$this->data['config_image_cat_width'] = $this->request->post['config_image_cat_width'];
		} else {
			$this->data['config_image_cat_width'] = $this->config->get('config_image_cat_width');
		}
		
		if (isset($this->request->post['config_image_cat_height'])) {
			$this->data['config_image_cat_height'] = $this->request->post['config_image_cat_height'];
		} else {
			$this->data['config_image_cat_height'] = $this->config->get('config_image_cat_height');
		}
	...
	private function validate() {
		...
		if (!$this->request->post['config_image_cat_width'] || !$this->request->post['config_image_cat_height']) {
			$this->error['image_cat'] = $this->language->get('error_image_cat');
		} 
		
		if (!$this->request->post['config_image_news_width'] || !$this->request->post['config_image_news_height']) {
			$this->error['image_news'] = $this->language->get('error_image_news');
		}		
