	...
	private $error = array(); 
  	...
  	private function getForm() {
		...
		$route = $this->request->get['route'];							
  		if($route == 'catalog/product/insert'){
		$product_max = $this->model_catalog_product->getProductMax();
		$this->data['now'] = ($product_max['product_id']+1) * ($product_max['product_id']+1);
  		}else{
  			$product_info = $this->model_catalog_product->getProduct($this->request->get['product_id']);
  			$this->data['now'] = $product_info['product_id'] * $product_info['product_id'];
  		}
