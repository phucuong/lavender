<?php 
/*
	Model này tùng add để phục vụ một số công việc cơ bản trong quá trình xử lý dữ liệu 
	của các phần mà tùng phát triển opencartVN 
	
	Mục đích tùng tách ra để tránh đụng chạm quá nhiều tới code gốc của opencart, ảnh hưởng tới việc tích
	hợp thêm các phần mở rộng của các bạn, và cũng để việc cập nhật các phiên bản gốc sang opencartVN mà
	tùng phát triển được thuận lợi hơn
