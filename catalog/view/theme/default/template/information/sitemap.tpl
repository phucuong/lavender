  ...
  <div class="sitemap-info">
    <div class="left">
      <ul>
		...
		<?php foreach ($cats as $cat_1) { ?>
        <li><a href="<?php echo $cat_1['href']; ?>"><?php echo $cat_1['name']; ?></a>
          <?php if ($cat_1['childrennews']) { ?>
          <ul>
            <?php foreach ($cat_1['childrennews'] as $cat_2) { ?>
            <li><a href="<?php echo $cat_2['href']; ?>"><?php echo $cat_2['name']; ?></a>
              <?php if ($cat_2['childrennews']) { ?>
              <ul>
                <?php foreach ($cat_2['childrennews'] as $cat_3) { ?>
